...
class AccountPayablesAging extends BaseReport {
    constructor() {
        super();
    }
    ...
    async formatHtml(formattedData) {
        return format("accountPayablesAging",formattedData);
    }

    async formatXml(contents) {
        return array2xml("accountPayablesAging",contents);
    }
    ...
    async retrieveReportDataSync(startDate, endDate) {
        return await this.accountsPayableAgingReportSync(startDate, endDate);
    }
}

module.exports = AccountPayablesAging;