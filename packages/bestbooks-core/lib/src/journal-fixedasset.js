...
class FixedAssetJournal extends Journal {
    constructor() {
        super("FixedAsset"); // Sets the name of the journal to 'FixedAsset'
    }

    /**
     * Records a transaction related to a fixed asset.
     * @param {Object} record - The asset record with properties: date, ref, account, debit, credit, company_id, office_id.
     */
    async recordAssetTransaction(record) {
    ...
    /**
     * Calculates the balance for the fixed asset journal.
     * @returns {Promise<number>} The balance of the fixed asset journal.
     */
    ...
    /**
     * Retrieves all transactions in the fixed asset journal.
    ...
    /**
     * Updates an existing fixed asset transaction.
    ...
    /**
     * Removes a fixed asset transaction by ID.
