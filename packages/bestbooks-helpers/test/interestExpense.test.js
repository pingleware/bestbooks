const assert = require('assert');
    const {interestExpense} = require('../index');
    const {
      Model,
    ...
    describe('interestExpense Testing', () => {
      ...
      it('should verify interestExpense does exist', () => {
        // Sample test
        assert.ok(interestExpense, 'interestExpense should be defined');
      });

      it('should create interest expense journal entry', async () => {
        // Call the interestExpense function
        await interestExpense(date, "Interest Expense for Loan", 1000);
      });
        ...
        const expected = [
          {
            ...
            txdate: date,
            note: 'Interest Expense for Loan',
            ref: 1,
            debit: 1000,
            credit: 0,
            balance: 1000,
