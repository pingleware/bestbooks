const assert = require('assert');
    ...
    describe('exchangeUSDToCryptocurrency Testing', () => {
      ...
      it('should exchange USD to Cryptocurrency', async () => {
        await exchangeUSDToCryptocurrency(date, "Exchange USD to ETH", 10, 1);
      });
      ...
      it("should show ledger table contents",async()=>{
        ...
        const expected = [
          ...
          },
          {
            ...
            txdate: date,
            note: 'fee for Exchange USD to ETH',
            ref: 3,
            debit: 1,
            credit: 0,
            balance: 1,
