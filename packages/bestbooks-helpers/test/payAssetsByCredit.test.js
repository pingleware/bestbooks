const assert = require('assert');
    const {payAssetsByCredit} = require('../index');
    const {
      Model,
    ...
    describe('payAssetsByCredit Testing', () => {
      ...
      it('should verify payAssetsByCredit does exist', () => {
        // Sample test
        assert.ok(payAssetsByCredit, 'payAssetsByCredit should be defined');
      });

      it('should record asset payment using credit',async()=>{
        await payAssetsByCredit(date,"Payment of Asset",500,"Equipment");
      })
      ...
      it("should show the accounts table contents",async()=>{
        ...
        assert.strictEqual(result[0].name, 'Equipment');
