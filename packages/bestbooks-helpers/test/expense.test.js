const assert = require('assert');
    ...
    describe('expense Testing', () => {
      ...
      it("should record an expense of $500 for office supplies",async()=>{
        await expense("Office Supplies",date,"Office Supplies",500);
      });

      it("should credit a partial refund of $100 for office supplies",async()=>{
        await expense("Office Supplies",date,"Office Supplies Refund", -100);
      });
