const assert = require('assert');
    const {securityDepositReceived} = require('../index');
    const {
      Model,
    ...
    describe('securityDepositReceived Testing', () => {
      ...
      it('should verify securityDepositReceived does exist', () => {
        // Sample test
        assert.ok(securityDepositReceived, 'securityDepositReceived should be defined');
      });

      it("should record a refundable security deposit",async()=>{
        await securityDepositReceived(date,"security deposit",100);
      })
      ...
      it("should show ledger table contents",async()=>{
        ...
        const expected = [
          ...
          },
          {
            ...
            office_id: 0,
            account_code: '200',
            account_name: 'Refundable Security Deposit',
            txdate: date,
            note: 'security deposit',
            ref: 2,
            debit: 0,
      ...
      it("should show the journal table contents",async()=>{
        ...
        const expected = [
          ...
          },
          {
            ...
            location_id: null,
            txdate: date,
            account: 'Refundable Security Deposit',
            ref: 2,
            debit: 0,
            credit: 100
          }
      ...
      it("should show the accounts table contents",async()=>{
        ...
        assert.strictEqual(result[1].name, 'Refundable Security Deposit');
