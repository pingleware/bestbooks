const assert = require('assert');
    ...
    describe('liability Testing', () => {
      ...
      it('should verify liability does exist', () => {
        // Sample test
        assert.ok(liability, 'liability should be defined');
      });

      it('should add an increasing entry to the libility account', async () => {
        await liability("Accounts Payable", date, "Test Liability Entry", 1000);
      });

      it('should add a decreasing entry to the libility account', async () => {
        await liability("Accounts Payable", date, "Test Liability Entry", -500);
      });
      ...
      it("should show ledger table contents",async()=>{
        ...
        assert.strictEqual(result[1].balance, 500, 'Balance should be 500');
      })
      ...
      it("should show the accounts table contents",async()=>{
        ...
        assert.strictEqual(result[0].name, 'Accounts Payable');
