const assert = require('assert');
    const {payExpenseByCheck} = require('../index');
    const {
      Model,
    ...
    describe('payExpenseByCheck Testing', () => {
      ...
      it('should verify payExpenseByCheck does exist', () => {
        // Sample test
        assert.ok(payExpenseByCheck, 'payExpenseByCheck should be defined');
      });

      it('should record entry when company writes a check to pay for $318 of office supplies',async()=>{
        await payExpenseByCheck(date,"Office supplies",318,"Office Supplies");
      })
      ...
      it("should show the accounts table contents",async()=>{
        ...
        assert.strictEqual(result[1].name, 'Office Supplies');
