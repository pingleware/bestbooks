const assert = require('assert');
    const {createAccountInstance} = require('../index');
    const {
      Model,
    ...
    describe('createAccountInstance Testing', () => {
      ...
      it('should verify createAccountInstance does exist', () => {
        // Sample test
        assert.ok(createAccountInstance, 'createAccountInstance should be defined');
      });

      it("should create a Cash account instance",async()=>{
        await createAccountInstance("Cash","Asset");
      })
