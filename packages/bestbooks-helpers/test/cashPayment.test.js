const assert = require('assert');
    ...
    describe('cashPayment Testing', () => {
      ...
      it("should make a payment in cash",async()=>{
        await cashPayment(date, "Payment for office supplies", 317.89);
      });
      ...
      it("should show ledger table contents",async()=>{
        ...
        result.forEach(row => {
          ...
          } else if (row.account_name === "Cost of Goods Sold") {
      ...
      it("should show the accounts table contents",async()=>{
        ...
        assert.strictEqual(result[1].name, 'Cost of Goods Sold');
