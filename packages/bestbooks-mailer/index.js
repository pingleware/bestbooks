...
/**
 * Generate DKIM key pair (private/public) for a given domain and selector.
 * Returns an object with { privateKey, publicKey, selector, domain }
 */

/**
 * Create DKIM key pair
 * @param {string} domain - The domain for which to generate the DKIM key
 * @param {string} selector - The DKIM selector (e.g., "default")
 * @returns {Object} { privateKey, publicKey, selector, domain }
 */
async function CreateDkimKey(domain, selector = "default") {
