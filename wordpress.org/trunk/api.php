...
if (!function_exists('bestbooks_api_version')) {
    /**
...
if (!function_exists('bestbooks_api_settings')) {
    /**
...
if (!function_exists('bestbooks_api_chartofaccounts')) {
    /**
...
if (!function_exists('bestbooks_api_get_acctypes')) {
...
if (!function_exists('bestbooks_api_debit')) {
...
if (!function_exists('bestbooks_api_credit')) {
...
if (!function_exists('bestbooks_api_balance')) {
...
if (!function_exists('bestbooks_api_add')) {
    /**
...
if (!function_exists('bestbooks_api_subtract')) {
    /**
...
if (!function_exists('bestbooks_api_headers')) {
...
if (!function_exists('bestbooks_authenticate')) {
...
if (!function_exists('bestbooks_disable_rest_endpoints')) {
    /**
