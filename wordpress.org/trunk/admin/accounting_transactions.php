...
function bestbooks_dashboard_accounting_transactions() {
	...
	$results = Ledger::getAll($active_company);
	$total = $results['total'];
	...
	<div class="wrap">
		<h2>BestBooks<sup>&reg;&trade;</sup> - <a href="<?php echo admin_url('admin.php?page=bestbooks_accounting'); ?>">Accounting</a> - Transactions&nbsp;
