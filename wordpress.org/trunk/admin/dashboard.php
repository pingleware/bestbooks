...
function bestbooks_dashboard_page() {
	?>
    <div class="wrap">
        <h2>BestBooks<sup>&reg;&trade;</sup> Accounting Application Framework</h2>
        <p><i>BestBooks<sup>&reg;&trade;</sup> Accounting Application Framework is a registered trademark of PressPage Entertainment Inc.</i></p>
